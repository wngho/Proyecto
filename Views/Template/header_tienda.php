					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="<?= base_url(); ?>" class="amenu">Inicio</a>
							</li>

							<li>
								<a href="<?= base_url(); ?>/tienda" class="amenu">Tienda</a>
							</li>

							<li>
								<a href="<?= base_url(); ?>/carrito" class="amenu">Carrito</a>
							</li>
							
							<!--<li>
								<a href="<?= base_url(); ?>/nosotros" class="amenu">Nosotro</a>
							</li>

							<li>
								<a href="<?= base_url(); ?>/sucursales" class="amenu">Sucursales</a>
							</li>-->

							<li>
								<a href="<?= base_url(); ?>/contacto" class="amenu">Contacto</a>
							</li>
						</ul>
					</div>	
