            ...
            <form id="formCliente" name="formCliente" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="txtIdentificacion">Cedula <span class="required">*</span></label>
                  <input type="text" class="form-control" id="txtIdentificacion" name="txtIdentificacion" maxlength="9" required="">
                </div>
                <div class="form-group col-md-4">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" id="txtNit" name="txtNit" maxlength="10" required="">
                </div>
                <div class="form-group col-md-6">
                  <label>Razon fiscal <span class="required">*</span></label>
