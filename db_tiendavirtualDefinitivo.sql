...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2025 a las 06:10:38
...
INSERT INTO `categoria` (`idcategoria`, `nombre`, `descripcion`, `portada`, `fecha_creacion`, `ruta`, `status`) VALUES
(1, 'Hombre', 'Artículos de moda', 'img_125e45445bd33723d025d7f815ca29f7.jpg', '2021-08-20 03:04:04', 'hombre', 1),
(2, 'Audio y Videojuegos', 'Lo mejor en tecnología', 'img_622b29a306cb24cc869818c75c445d1a.jpg', '2021-08-21 00:47:10', 'audio-y-videojuegos', 1);
...
CREATE TABLE `compra` (
  ...
  `id_distribuidor` bigint(20) NOT NULL,
...
CREATE TABLE `compra_producto` (
  `id_compra_producto` bigint(20) NOT NULL,
  `id_compra` bigint(20) NOT NULL,
...
INSERT INTO `contacto` (`id`, `nombre`, `email`, `mensaje`, `fecha_creacion`) VALUES
(1, 'Fernando Herrera', 'toolsfordeveloper@gmail.com', 'Mensaje del primer suscriptor!', '2021-08-20 04:06:18'),
(2, 'Ricardo', 'ricardo@gmail.com', 'Aqui Primer mensaje', '2025-05-18 15:24:41'),
(3, 'Juan', 'juan@gmail.com', 'SDADSAD', '2025-05-18 15:25:34'),
(4, 'Sadasd', 'asdasd@gmail.com', 'asdasdas', '2025-05-18 16:00:36');
...
CREATE TABLE `estados` (
  ...
  `color` varchar(20) NOT NULL COMMENT 'Color para representar el estado',
...
INSERT INTO `estados` (`idestado`, `nombre`, `color`, `status`) VALUES
(1, 'Recibido', '#3498db', 1),
(2, 'En diagnóstico', '#f39c12', 1),
(3, 'En reparación', '#e74c3c', 1),
(4, 'Reparado', '#2ecc71', 1),
(5, 'Entregado', '#27ae60', 1),
(6, 'No reparable', '#95a5a6', 1);
...
CREATE TABLE `fotos` (
  ...
  `ruta` varchar(255) NOT NULL COMMENT 'Ruta del archivo en el servidor',
  `descripcion` varchar(255) DEFAULT NULL COMMENT 'Descripción opcional de la foto',
...
(12, 'ServicioTecnico', 'Modulo de servicio tecnico', 1);
...
CREATE TABLE `movimientos` (
  ...
  `idservicio` int(11) NOT NULL,
  `idtecnico` bigint(20) NOT NULL COMMENT 'Técnico que realizó el movimiento',
  `idestado_anterior` int(11) DEFAULT NULL,
  `idestado_nuevo` int(11) NOT NULL,
  `descripcion` text DEFAULT NULL COMMENT 'Descripción del cambio/movimiento',
  `fecha` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci;
...
(3, '1231241241', NULL, NULL, 5, '2025-05-18 15:14:31', 5.00, 305.00, 2, 'asdsadas, asdasdas', 'Completo'),
(4, 'adsdasd', NULL, NULL, 5, '2025-05-18 15:15:21', 5.00, 305.00, 2, 'asdasd, asdasd', 'Completo'),
(5, 'ssss', NULL, NULL, 5, '2025-05-18 15:16:12', 5.00, 305.00, 2, 'dasa, adsada', 'Cancelado'),
(6, NULL, NULL, NULL, 6, '2025-05-19 19:57:55', 5.00, 305.00, 2, 'resis, resis', 'Pendiente'),
(7, NULL, NULL, NULL, 6, '2025-05-19 19:58:47', 5.00, 105.00, 2, 'res, res', 'Pendiente'),
(8, NULL, NULL, NULL, 6, '2025-05-19 21:49:46', 5.00, 105.00, 2, 'eee, eee', 'Pendiente'),
(9, '2222', NULL, NULL, 6, '2025-05-20 01:46:25', 5.00, 405.00, 2, 'aa, aa', 'Completo');
...
(5, NULL, 'Omar', 'Pineda', 123456677, 'ricardo@gmail.com', '33473153290be6264ca6f34d0e031feaa568e609ed67225b5a5501ddecd7c67d', NULL, NULL, NULL, NULL, 3, '2025-05-18 15:14:19', 1),
(6, NULL, 'Hola', 'Hola', 823141741, 'hola@hola.com', '0c6f1dff3779f963cc8cd5863f11f0ec3613eec89960ab9bdbe76317962f8fde', NULL, NULL, NULL, NULL, 3, '2025-05-19 19:57:45', 1);
...
(1, 'Inicio', '<div class=\"p-t-80\"> <h3 class=\"ltext-103 cl5\">Nuestras marcas</h3> </div> <div> <p>Trabajamos con las mejores marcas del mundo ...</p> </div> <div class=\"row\"> <div class=\"col-md-3\"><img class=\"img-thumbnail\" src=\"Assets/images/m1.png\" alt=\"Marca 1\" /></div> <div class=\"col-md-3\"><img class=\"img-thumbnail\" src=\"Assets/images/m2.png\" alt=\"Marca 2\" /></div> <div class=\"col-md-3\"><img class=\"img-thumbnail\" src=\"Assets/images/m3.png\" alt=\"Marca 3\" /></div> <div class=\"col-md-3\"><img class=\"img-thumbnail\" src=\"Assets/images/m4.png\" alt=\"Marca 4\" /></div> </div>', '', '2021-07-20 02:40:15', 'inicio', 1),
...
(3, 2, '4658798787', 'Bocina JBL Flip 5', '<p>Wireless Bluetooth streaming. 24 hours of playtime. IPX7 waterproof. JBL Connect plus. High-capacity battery. Connector type: 3.5 millimeter stereo. Power Source Type: Battery Powered.</p>', 300.00, 100, NULL, '2021-08-21 00:48:21', 'bocina-jbl-flip-5', 2);
...
CREATE TABLE `serial` (
  ...
  `estado` enum('disponible','vendido','defectuoso') NOT NULL DEFAULT 'disponible',
  `datecreated` datetime NOT NULL DEFAULT current_timestamp(),
  `status` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci;
...
CREATE TABLE `servicios` (
  `idservicio` int(11) NOT NULL,
  `num_serie` varchar(50) NOT NULL COMMENT 'Número de serie del equipo',
  `descripcion` text NOT NULL COMMENT 'Descripción del problema/equipo',
...
ALTER TABLE `compra_producto`
  ...
  ADD UNIQUE KEY `unique_compra_producto` (`id_compra`,`id_producto`),
...
ALTER TABLE `fotos`
  ...
  ADD KEY `fk_fotos_servicio` (`idservicio`);
...
ALTER TABLE `movimientos`
  ...
  ADD KEY `fk_movimiento_servicio` (`idservicio`),
  ADD KEY `fk_movimiento_tecnico` (`idtecnico`),
  ADD KEY `fk_movimiento_estado_anterior` (`idestado_anterior`),
  ADD KEY `fk_movimiento_estado_nuevo` (`idestado_nuevo`);
...
ALTER TABLE `serial`
  ...
  ADD KEY `id_compra_producto` (`id_compra_producto`);
...
--
ALTER TABLE `compra_producto`
  MODIFY `id_compra_producto` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `distribuidor`
  MODIFY `id_distribuidor` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `permisos`
  MODIFY `idpermiso` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `serial`
  MODIFY `id_serial` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `Compra_ibfk_1` FOREIGN KEY (`id_distribuidor`) REFERENCES `distribuidor` (`id_distribuidor`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `compra_producto`
--
ALTER TABLE `compra_producto`
  ADD CONSTRAINT `Compra_Producto_ibfk_1` FOREIGN KEY (`id_compra`) REFERENCES `compra` (`id_compra`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Compra_Producto_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`idproducto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `fotos`
  ADD CONSTRAINT `fk_fotos_servicio` FOREIGN KEY (`idservicio`) REFERENCES `servicios` (`idservicio`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `movimientos`
  ADD CONSTRAINT `fk_movimiento_estado_anterior` FOREIGN KEY (`idestado_anterior`) REFERENCES `estados` (`idestado`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_movimiento_estado_nuevo` FOREIGN KEY (`idestado_nuevo`) REFERENCES `estados` (`idestado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_movimiento_servicio` FOREIGN KEY (`idservicio`) REFERENCES `servicios` (`idservicio`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `serial`
  ADD CONSTRAINT `Serial_ibfk_1` FOREIGN KEY (`id_compra_producto`) REFERENCES `compra_producto` (`id_compra_producto`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `servicios`
--
ALTER TABLE `servicios`
  ADD CONSTRAINT `fk_servicio_cliente` FOREIGN KEY (`idcliente`) REFERENCES `persona` (`idpersona`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_servicio_estado` FOREIGN KEY (`idestado`) REFERENCES `estados` (`idestado`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
