    ...
    <!-- Sección de bienvenida -->
      <main class="container-fluid mt-3 ">
        ...
        <?php require_once "common/aside.php";?>
          <article class="col-lg-8 px-4">
            <header class="mt-3 display-6">
              <span class="fw-bold text-decoration-underline text-warning">Ventas</span>
            </header>
            <ul class="nav nav-pills mt-4 nav-ventas" id="pills-tab" role="tablist">
              <li class="nav-item me-3" role="presentation">
                <button class="nav-link active fw-bold" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Activa</button>
              </li>
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                ...
                <div class="mt-3 d-flex justify-content-end">
                  <button type="button"class="btn btn-outline-primary py-1 px-2" data-bs-toggle="modal" data-bs-target="#agregarProductoModal"><i class="bi bi-box-arrow-down me-2"></i><small>Registrar Nota de Entrega</small></button>
                  <button type="button"class="btn btn-outline-primary py-1 px-2 mx-2" data-bs-toggle="modal" data-bs-target="#agregarProductoModal"><i class="bi bi-box-arrow-in-down me-2"></i><small>Registrar Nota Interna</small></button>                  
                </div>
                <div class="mt-3 d-flex justify-content-end">
                  <button type="button"class="btn btn-primary btn-sm py-1 px-2 mx-2" data-bs-toggle="modal" data-bs-target="#agregarProductoModal"><i class="bi bi-funnel-fill me-2"></i><small>Filtrar</small></button>                  
                </div>
          ...
          <aside class="col-lg-2 pe-3 pb-4 d-flex align-items-center">
            <ul class="list-group flex-fill pb-4">
              <li class="list-group-item text-warning">
                <i class="bi bi-people-fill fs-3"></i><span class="display-6 fs-4 fw-medium">  Clientes</span>
              </li>
              <li class="list-group-item p-1 d-flex text-center">
                <a href="" class="list-group-item list-group-item-action list-group-item-primary rounded p-1 fs-5 display-6"><i class="bi bi-person-fill-add fs-4 pe-3"></i> Registrar Clientes</a></li>
              <li class="list-group-item p-1">
                <ul class="list-group list-group-horizontal text-center">
                  <a href="" class="list-group-item list-group-item-action list-group-item-secondary" data-bs-toggle="tooltip" data-bs-custom-class="ToolTikCustom" data-bs-placement="bottom" data-bs-title="Modifciar">
                    <i class="bi bi-pencil-square"></i>
                  </a>
                  <a href="" class="list-group-item list-group-item-action list-group-item-info" data-bs-toggle="tooltip" data-bs-custom-class="ToolTikCustom" data-bs-placement="bottom" data-bs-title="Consultar">
                    <i class="bi bi-search"></i>
                  </a>
                  <a href="" class="list-group-item list-group-item-action list-group-item-danger" data-bs-toggle="tooltip" data-bs-custom-class="ToolTikCustom" data-bs-placement="bottom" data-bs-title="Eliminar">
